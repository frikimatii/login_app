...
export default function Login({ navigation }) {
  ...
  const [secureTextEntry, setSecureTextEntry] = useState(true); // Estado para controlar la visibilidad de la contraseña
      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            secureTextEntry={secureTextEntry} // Usar el estado para ocultar o mostrar la contraseña
            onChangeText={(text) => setPassword(text)}
            value={password}
            placeholderTextColor="#888"
          />
          <TouchableOpacity onPress={toggleSecureEntry} style={styles.eyeButton}>
            <Text style={styles.eyeButtonText}>{secureTextEntry ? "Mostrar" : "Ocultar"}</Text>
          </TouchableOpacity>
        </View>
